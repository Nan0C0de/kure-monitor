  ...
  const renderCode = () => {
    if (language === 'diff') {
      ...
      return lines.map((line, i) => {
        let lineClass = '';
        if (line.startsWith('+')) lineClass = 'text-green-400 bg-green-900/30 w-full inline-block px-1 -mx-1';
        else if (line.startsWith('-')) lineClass = 'text-red-400 bg-red-900/30 w-full inline-block px-1 -mx-1';
