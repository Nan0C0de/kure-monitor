  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      ...
      <div
        ...
        aria-modal="true"
        aria-label="Test Fix"
        className={`relative rounded-lg text-left overflow-hidden shadow-xl transform transition-all w-full max-h-full flex flex-col ${
          stage === 'edit' || stage === 'loading-manifest' ? 'max-w-3xl' : 'max-w-lg'
        } ${isDark ? 'bg-gray-800' : 'bg-white'}`}
      >
        <div className={`px-4 pt-5 pb-4 sm:p-6 sm:pb-4 overflow-y-auto ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
            {/* Header */}
