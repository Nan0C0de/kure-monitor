...
<CardGrid>
	...
	<LinkCard
		...
		href="/kure-monitor/release-notes/2-4-2/"
		description="What's new in 2.4.2 — sixteen new AI Advice detectors (38 total), Active/Ignored tabs for findings, and a fix for the false-positive Secret reference check."
	/>
</CardGrid>
