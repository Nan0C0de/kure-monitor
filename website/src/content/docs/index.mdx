...
<CardGrid>
	...
	<LinkCard
		...
		href="/kure-monitor/release-notes/2-3-4/"
		description="What changed in 2.3.4 — Groq is the new default LLM provider, model lists refreshed across all six providers."
	/>
</CardGrid>
