...
Kure Monitor 2.3.0 contains **two breaking changes** (auth overhaul, cluster metrics removal), one new LLM provider (GitHub Copilot / GitHub Models), refreshed model catalogs, and two UI bug fixes. Read the [Migration Guide](/migration/2-2-to-2-3/) in full before upgrading.
...
See the dedicated [2.2 → 2.3 migration guide](/migration/2-2-to-2-3/).
