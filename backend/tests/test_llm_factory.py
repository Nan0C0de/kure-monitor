...
class TestLLMFactory:
    ...
    def test_create_openai_provider(self):
        ...
        provider = LLMFactory.create_provider(
            provider_name="openai", api_key="test-key", model="gpt-5.5-mini"
        )
    ...
    def test_create_anthropic_provider(self):
        ...
        provider = LLMFactory.create_provider(
            provider_name="anthropic", api_key="test-key", model="claude-sonnet-4-6"
        )
        assert provider is not None
    ...
    def test_create_groq_provider(self):
        ...
        provider = LLMFactory.create_provider(provider_name="groq", api_key="test-key")
        assert provider is not None
    ...
    def test_create_provider_with_alias_claude(self):
        ...
        provider = LLMFactory.create_provider(
            provider_name="claude", api_key="test-key"
        )
        assert provider is not None
        assert provider.provider_name == "anthropic"
    ...
    def test_create_provider_with_alias_groq_cloud(self):
        ...
        provider = LLMFactory.create_provider(
            provider_name="groq_cloud", api_key="test-key"
        )
        assert provider is not None
        assert provider.provider_name == "groq"
    ...
    def test_create_gemini_provider(self):
        ...
        provider = LLMFactory.create_provider(
            provider_name="gemini", api_key="test-key", model="gemini-3-flash"
        )
        assert provider is not None
    ...
    def test_create_provider_with_alias_google(self):
        ...
        provider = LLMFactory.create_provider(
            provider_name="google", api_key="test-key"
        )
        assert provider is not None
        assert provider.provider_name == "gemini"
    ...
    def test_invalid_provider(self):
        ...
        with pytest.raises(ValueError) as exc_info:
            LLMFactory.create_provider(provider_name="invalid", api_key="test-key")
    ...
    def test_create_copilot_provider(self):
        ...
        provider = LLMFactory.create_provider(
            provider_name="copilot", api_key="ghp_test-token"
        )
        assert provider is not None
    ...
    def test_create_copilot_provider_with_alias_github(self):
        ...
        provider = LLMFactory.create_provider(
            provider_name="github", api_key="ghp_test-token"
        )
        assert provider is not None
        assert provider.provider_name == "copilot"
    ...
    def test_create_copilot_provider_with_alias_github_models(self):
        ...
        provider = LLMFactory.create_provider(
            provider_name="github_models", api_key="ghp_test-token"
        )
        assert provider is not None
        assert provider.provider_name == "copilot"
    ...
    def test_copilot_base_url_override(self):
        ...
        assert (
            provider.API_URL == "https://models.example.com/inference/chat/completions"
        )
